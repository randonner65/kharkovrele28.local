...
$mark = $PropertiesSwitcher[mark];//маркировка положений
 ...
 //Если ключ
  ...
  $tds->size_line (-3, 3, 3, -3, ' ø9', 8);
	}
	else {
	$tds->size_line (-18, 35, 18, 35, '□75', -3);
	$tds->size_line (-16, -16, -20, -20, '2 отв. М5', -22);
	$tds->size_line (-3, 3, 3, -3, ' ø10', 8);
	}	
...
if($_GET["flag"] == 1) imageJpeg(ToolsDrawingSwitcher::$i, '../images/passport/'.$name.'_fix_holes.jpg');
  else imageJpeg(ToolsDrawingSwitcher::$i);
